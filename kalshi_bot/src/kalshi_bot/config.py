...
class Settings:
    ...
    crypto_min_open_interest: float = float(os.getenv("CRYPTO_MIN_OPEN_INTEREST", "1"))
    crypto_min_volume_24h: float = float(os.getenv("CRYPTO_MIN_VOLUME_24H", "100"))
    crypto_min_secs_left: int = int(os.getenv("CRYPTO_MIN_SECS_LEFT", "45"))
    crypto_max_secs_left: int = int(os.getenv("CRYPTO_MAX_SECS_LEFT", "930"))
    crypto_min_premium_cents: int = int(os.getenv("CRYPTO_MIN_PREMIUM_CENTS", "5"))
    crypto_max_premium_cents: int = int(os.getenv("CRYPTO_MAX_PREMIUM_CENTS", "85"))
    crypto_max_confidence: float = float(os.getenv("CRYPTO_MAX_CONFIDENCE", "0.95"))
    crypto_max_abs_d2: float = float(os.getenv("CRYPTO_MAX_ABS_D2", "6.0"))
    crypto_momentum_cache_ttl_seconds: float = float(
        os.getenv("CRYPTO_MOMENTUM_CACHE_TTL_SECONDS", "20")
    )
